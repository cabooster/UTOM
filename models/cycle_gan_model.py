...
class CycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--threshold_A', type=float, default=92, help='weight for cycle loss (A -> B -> A)')
            parser.add_argument('--threshold_B', type=float, default=195, help='weight for cycle loss (B -> A -> B)')
