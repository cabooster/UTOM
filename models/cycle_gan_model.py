...
class CycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--threshold_A', type=float, default=70, help='weight for cycle loss (A -> B -> A)')
            parser.add_argument('--threshold_B', type=float, default=220, help='weight for cycle loss (B -> A -> B)')
    ...
    def content_loss(self):
        ...
        content_loss_rate = 10*np.exp(-(self.opt.counter/self.opt.data_size*2))
